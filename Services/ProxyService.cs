...
{
    /// <summary>
    /// Manages Windows system-wide proxy settings via registry.
    ...
    internal class ProxyService(ILogger<ProxyService> logger)
    {
        ...
        /// <summary>
        /// Enables the system proxy with the specified configuration.
        /// </summary>
        /// <param name="proxyConfig">Proxy configuration (hostname and port).</param>
