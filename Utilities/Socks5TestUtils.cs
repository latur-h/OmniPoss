...
{
    internal static class Socks5TestUtils
    {
        public static async Task<NatTypeTestResult> DiscoveryNatTypeAsync(Socks5ClientService socks5, CancellationToken ctx = default)
        {
            var stunServer = "stun.syncthing.net";
            var port = (ushort)3478;
        ...
        public static async Task<int?> HttpConnectAsync(Socks5ClientService socks5, CancellationToken ctx)
        {
            var socks5Option = new Socks5CreateOption
            {
                Address = await DnsUtils.LookupAsync(socks5.Hostname),
