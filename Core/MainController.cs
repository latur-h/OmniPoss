...
{
    /// <summary>
    /// Orchestrates the SOCKS5 server endpoint and network filter controller.
    /// Coordinates DNS resolution, firewall rules, and kernel driver initialization.
    /// </summary>
    internal class MainController
    {
        /// <summary>
        /// SOCKS5 client service pointing to the core's SOCKS5 server endpoint.
        /// </summary>
        public Socks5ClientService Socks5Server { get; }

        /// <summary>
        /// Network filter controller managing kernel driver and redirector configuration.
        /// </summary>
        ...
        /// <summary>
        /// Whether the OmniPoss service is currently running.
        /// </summary>
        public bool IsRunning { get; private set; }

        /// <summary>
        /// Initializes a new instance of MainController.
        /// </summary>
        /// <param name="socks5Server">SOCKS5 client service for the core endpoint.</param>
        /// <param name="controller">Network filter controller.</param>
        ...
        public async Task StartAsync()
        {
            ...
            try
            {
                ...
                await Task.WhenAll(Task.Run(NativeMethods.RefreshDNSCache), Task.Run(FirewallUtils.AddNetFilterFwRules));
        ...
        /// <summary>
        /// Stops the OmniPoss service and releases resources.
        /// </summary>
